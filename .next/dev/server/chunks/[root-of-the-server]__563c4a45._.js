...
"[project]/src/app/api/view/[token]/session/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        const shareToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].proposalShareToken.findUnique({
            where: {
                token
            },
            select: {
        ...
        if (action === 'start') {
            ...
            if (shareToken.isPortalUser && shareToken.portalUserId) {
                const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].clientProfile.findUnique({
                    where: {
                        userId: shareToken.portalUserId
                    },
                    select: {
                        clientId: true
                    }
            ...
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].proposalSession.create({
                data: {
        ...
        if (action === 'heartbeat') {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].proposalSession.update({
                where: {
                    sessionId
                },
                data: {
        ...
        if (action === 'end') {
            ...
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].proposalSession.findUnique({
                where: {
                    sessionId
                },
                select: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__563c4a45._.js.map