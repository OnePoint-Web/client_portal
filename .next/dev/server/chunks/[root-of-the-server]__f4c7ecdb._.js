...
async function POST(req) {
    try {
        ...
        const passwordMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, user.userPassword);
        if (!passwordMatch) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid credentials'
            }, {
        ...
        const token = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"]({
            ...
            alg: 'HS256'
        }).setExpirationTime(sessionDuration).sign(new TextEncoder().encode(process.env.JWT_SECRET));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f4c7ecdb._.js.map